...
sources:
  - "pr: nooga/let-go#735 merged 2026-09-10 keeping the bundle skip; cmd/lgbgen isBundleSkippedTool covers ir.* and lg.compiler.* @ 36b13f79, 2026-09-20"
...
- #735 extracts that orchestration into a namespace of its own as groundwork for #596, the first-class `lg compile` command. It proposed `lg.aotdriver`; after the review below it landed as `lg.compiler`, merged 2026-09-10.
